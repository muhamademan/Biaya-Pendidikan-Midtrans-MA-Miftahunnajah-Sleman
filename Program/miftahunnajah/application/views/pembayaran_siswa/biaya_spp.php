<div class="card-body">
    <div class="card shadow mb-4 border-bottom-warning" id="tagihanbulanan" value="0">
        ...
        <a href="#tagihanbulan" class="d-block bg-warning border border-warning card-header py-3" data-toggle="collapse"
                                ...
                                <td>
                                    <?php
                                        if ($u->status_bayar != 'Lunas') {
                                            echo anchor('siswa_bulanan/bayar_spp/' . $u->id_spp . '/' . $u->id_siswa, '<input type=submit class="btn btn-warning" value=\'bayar\'>');
                                        }
                                        echo anchor('siswa_bulanan/cetak_spp/' . $u->id_spp . '/' . $u->id_siswa, 'Cetak', array('title' => 'Cetak kartu Pembayaran SPP', 'class' => 'btn btn-info'));
                                        ?>
                                </td>
                            </tr>
                            <?php } ?>
