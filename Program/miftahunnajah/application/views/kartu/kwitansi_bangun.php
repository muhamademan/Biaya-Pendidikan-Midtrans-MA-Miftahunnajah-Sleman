...
<div class="container-fluid">
    ...
    <table class="table">
        <tbody>
            ...
            <tr>
                <td style="width: 25%;text-align: left">Tagihan Biaya Bangunan </td>
                <td style="width: 75%;text-align: left">
                    <strong>Rp. <?= number_format($bayaran_bgn['jumlah'], 0, ',', '.') ?>,-</strong>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <p style="width: 30%;text-align: center">&nbsp;</p>
