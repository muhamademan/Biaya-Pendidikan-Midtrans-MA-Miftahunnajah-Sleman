            ...
            <div class="container">
                ...
                <div class="form-group" id="form-nis">
                    ...
                    <button id="cari-tunggakan" class="btn btn-success"
                        onclick="javascript: window.location = '<?= base_url('laporan_tunggak/lap_tgk?id_siswa=') ?>'+$('#siswa').val();"><i
                            class="fas fa-search"> Tampilkan</i></button>
                    <a href="<?php echo base_url('laporan_tunggak/lap_tgk'); ?>" class="btn btn-outline-danger mb-0"><i
                    ...
                    <td>
                        <center>
                            ...
                            <p>Ds. Wonorejo 01/08, Sardonoharjo, Ngaglik, Sleman, Daerah Istimewa Yogyakarta
                                55581, Telp. (0274) 9107446</p>
                        </center>
                    </td>
                </tr>
            </table>
            <h4>Laporan Tunggakan Pembayaran Bulanan (SPP)</h4>
        </center>
        <hr>
            ...
            <tbody>
                ...
                foreach ($result as $v) {
                    ...
                    echo '<tr>
							...
							<td style="text-align: right;"> Rp. ' . number_format(($v['jenis'] == '1' && $v['jml_bulan'] == 0 ? 12 * $v['besar_spp'] : ($v['jenis'] == '1' && $v['jml_bulan'] > 0 ? (12 * $v['besar_spp']) - $v['total_bayar'] : $v['total_bayar'])), 0, ',', '.') . '</td>
