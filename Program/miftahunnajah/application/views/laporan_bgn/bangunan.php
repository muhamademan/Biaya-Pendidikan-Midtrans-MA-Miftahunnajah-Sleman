<div class="container-fluid">
        ...
        <div class="card-body col-12">
            <div class="container">
                ...
                <form method="get" action="" class="form">
                    ...
                    <a href="<?php echo base_url() . "laporan_bangunan/lap_bangunan"; ?>"
                        class="btn btn-success mb-0"><i class="fas fa-refresh"></i></a>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <!-- <a href="<?php echo base_url() . "laporan_bangunan/lap_bangunan"; ?>"><i class="fas fa-refresh"></i>
                Refresh</a> -->
                ...
                <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <?php echo 'Rp. ' . number_format($data->besar_bangunan, 0, ',', '.'); ?></td>
                        </tr>
                        <?php }
                        }
                        ?>
