<div class="container-fluid">
                ...
                <form method="get" action="" class="form">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="filter" id="filter" style="width: 50%">
                            ...
                            <option value="2">Nama Siswa</option>
                            <option value="3">Tahun Ajaran</option>
                        </select>
                    </div>

                    <!-- Berdasarkan rentang tanggal pembayaran -->
                    <div class="form-group" id="form-tanggal">
                        <label>Dari Tanggal</label>
                        <input type="date" name="tanggal" class="form-control input-tanggal" style="width: 70%" />
                    </div>
                    <div class="form-group" id="form-tanggal2">
                        <label>Sampai Tanggal</label>
                        <input type="date" name="tanggal2" class="form-control input-tanggal2" style="width: 70%" />
                    </div>
                    ...
                    <a href="<?php echo base_url() . "laporan/laporan_spp"; ?>" class="btn btn-success mb-0"><i
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <!-- <a href="<?php echo base_url() . "laporan/laporan_spp"; ?>"><i class="fas fa-refresh"></i>
                Refresh</a> -->
                ...
                <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        if (!empty($pembayaran_spp)) {
                            $no = 1;
                            foreach ($pembayaran_spp as $data) {
                        ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <?php echo 'Rp. ' . number_format($data->besar_spp, 0, ',', '.'); ?></td>
                        </tr>
                        <?php }
                        }
                        ?>
