...
$pdf->MultiCell(31, 0.7, "DATA PEMBAYARAN SPP SISWA MA MIFTAHUNNAJAH SLEMAN", 0, 'C');
...
if (!empty($pembayaran_spp)) {
    ...
    // BAGIAN TOTAL PEMBAYARAN BIAYA SPP
    $pdf->SetFont('Arial', 'B', 10);
    $pdf->Cell(25, 0.8, 'TOTAL PEMBAYARAN BIAYA SPP', 1, 0, 'C');
    $pdf->Cell(3, 0.8, 'Rp. ' . number_format($total['jml'], 0, ',', '.'), 1, 0, 'C');
}

$pdf->SetFont('Times', '', 12);
$pdf->SetX(25);
$pdf->MultiCell(31, 5.5, 'Yogyakarta, ' . $tgl_cetak);
$pdf->SetX(25);
$pdf->MultiCell(31, 2.9, '( ......................................... )');
$pdf->Output("Laporan Pembayaran SPP.pdf", "I");