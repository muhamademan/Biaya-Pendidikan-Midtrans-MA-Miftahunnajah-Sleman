                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- hapus bangunan bulanan -->
                                        <?php echo anchor('bayar_ditempat/hapusBangunan/' . $u->id_transaksi . '/' . $u->id_siswa . '/' . $id_bangunan, '<input type=reset class="btn btn-outline-danger btn-sm" value=\'Hapus\'>'); ?>

                                        <!-- cetak kwitansi pembayaran bangunan -->
                                        <?php echo anchor('bayar_ditempat/kwitansiBangunan/' . $u->nis . '/' . $u->id_siswa, 'Kwitansi', array('title' => 'Cetak Kwitansi Pembayaran', 'class' => 'btn btn-outline-info btn-sm')); ?>
                                        <br>
        ...
        <div class="card">
            ...
            <div class="card-content">
                ...
                <form id="form-bangunan" class="form-inline" method="post"
                    action="<?= base_url('bayar_ditempat/tambah_Bangunan/'); ?>">
