                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- hapus spp bulanan -->
                                        <?php echo anchor('bayar_ditempat/hapus_spp/' . $u->id_transaksi . '/' . $u->id_siswa . '/' . $id_spp, '<input type=reset class="btn btn-outline-danger btn-sm" value=\'Hapus\'>'); ?>

                                        <!-- cetak kwitansi pembayaran spp -->
                                        <?php echo anchor('bayar_ditempat/kwitansi_Spp/' . $u->nis . '/' . $u->id_siswa, 'Kwitansi', array('title' => 'Cetak Kwitansi Pembayaran', 'class' => 'btn btn-outline-info btn-sm')); ?>
                                        <br>
        ...
        <div class="card">
            ...
            <div class="card-content">
                ...
                <form id="form-spp" class="form-inline" method="post"
                    action="<?= base_url('bayar_ditempat/tambah_aksi/'); ?>">
